...
class PiramideEx : public ObjMallaIndexada
{
	public:
		PiramideEx();
};
...
class ObjRevolucion2 : public ObjMallaIndexada
{
	public:
		ObjRevolucion2();
		ObjRevolucion2(const std::string & nombre_ply_perfil, bool tapa_sup, bool tapa_inf);

	protected:
		void crearMalla2(const std::vector<Tupla3f> &perfil_original, const int num_instancias_perf, bool tapa_sup, bool tapa_inf);
} ;
